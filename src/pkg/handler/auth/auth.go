...
// @Accept 	  json
// @Produce 	  json
// @Param input body ddo.SignUp true "sign up"
...
// @Accept 	  	 json
// @Produce 	 json
// @Param input body ddo.Login true "login"
// @Success 200 {object} ddo.LoginResponse
// @Failure 400 {object} handler_errors.ErrorResponse
// @Failure 404 {object} handler_errors.ErrorResponse
// @Router /user/login [post]
func (a *Handler) Login(ctx *gin.Context) {
	var request ddo.Login
	if err := ctx.BindJSON(&request); err != nil {
		a.logger.Error(err)
