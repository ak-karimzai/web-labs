...
func (t Repository) Create(ctx context.Context, goalId int, task ddo.CreateTask) (int, error) {
	var id int
...
func (t Repository) Get(ctx context.Context, goalId int, listParams ddo.ListParams) ([]model.Task, error) {
...
func (t Repository) UpdateByID(ctx context.Context, taskId int, task ddo.UpdateTask) error {
