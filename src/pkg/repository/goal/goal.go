...
func (g Repository) Create(ctx context.Context, userId int, goal ddo.CreateGoal) (int, error) {
	var id int
	query := `
...
func (g Repository) Get(ctx context.Context, userId int, listParams ddo.ListParams) ([]model.Goal, error) {
...
func (g Repository) UpdateByID(ctx context.Context, goalId int, update ddo.UpdateGoal) error {
